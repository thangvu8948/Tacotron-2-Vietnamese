...
from datasets import preprocessor_viet_tts as preprocessor
...
def norm_data(args):
	...
	supported_datasets = ['LJSpeech-1.0', 'LJSpeech-1.1', 'M-AILABS', 'Viet-TTS']
...
def main():
	...
	parser.add_argument('--dataset', default='Viet-TTS')

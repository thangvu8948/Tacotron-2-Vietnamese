...
def main():
	...
	parser.add_argument('--base_dir', default='D:/DatasetTTS/DatasetVPT')
	parser.add_argument('--hparams', default='',
		help='Hyperparameter overrides as a comma-separated list of name=value pairs')
	parser.add_argument('--tacotron_input', default='training_data/Viet_TTS/train.txt')
	...
	parser.add_argument('--eval_interval', type=int, default=5001,
	...
	accepted_models = ['Tacotron', 'WaveNet', 'Tacotron-2', "Viet-TTS"]
